...
export interface NemBlockchainWrapper {
  ...
  createMosaic(privateKey: string, maxAmount: number, supplyMutable: boolean, transferable: boolean, divisibility: number, durationCount?: number): Promise<MosaicEntity>
